                        ...
                        if(req.session.userResultList[0].isSecuredLogin=='Y'){
                            transporter.sendMail(mailOptions, function(error, response){
                                if(error){
                                    ...
                                    res.render('accountsummary', {
                                        title: '::-AccountSummary-::',
                                        userDetails: req.session.userResultList,page:'acc'
                                    });
                                }else{
            ...
            function (err, result)
            {
                ...
                if (err)
                {
                    ...
                    res.render('neftTransactionPassword', {
                        title: '::-TransactionPassword-::',msg:'',userDetails: req.session.userResultList,neftupdate:req.session.neftupdate,page:'neft-tr'
                    });
                }
                else
                {
                    res.render('nefttransaction', {
                        title: '::-NEFT Transaction-::',msg:'Available Balance Rs. '+req.session.userResultList[0].running_balance+' INR only',userDetails: req.session.userResultList,beneDetails: req.session.beneResultList,page:'neft'
                    });
                }
            });
});
                    ...
                    if(req.session.neftupdate){
                        ...
                        if(results){
                            res.render('nefttransactionconfirm', {
                                    ...
                                    results: results, userDetails: req.session.userResultList,page:'neft-cf'
                                });
                        }else{
                            res.render('nefttransaction', {
                                    title: '::-Transfer Failed-::',
                                    results: results, msg:'sorry unable to carry out your instruction',userDetails: req.session.userResultList,beneDetails: req.session.beneResultList,page:'neft'
                                });
                        }
    ...
    connection.query('SELECT * FROM beneficiary where source_acc_number=?',
        [userDetails[0].acc_number], function (err, results) {
            ...
            if (err) {
                ...
                res.render('nefttransaction', {
                    title: '::-NetBankingMenu-::',msg:'',userDetails: req.session.userResultList  ,beneDetails: req.session.beneResultList,page:'neft'
                });
            }
        });
   }
...
app.get('/transactionreport', function (req, res) {
    res.render('transactionreport', {
        title: '::-NetBankingMenu-::', msg: '', userDetails: req.session.userResultList,page:'acc-neft-rpt'
    });
});
    ...
    connection.query('SELECT *,DATE_FORMAT(transaction_date,"%d-%m-%Y") as tr_date FROM nefttransfer WHERE source_acc_number = ? and transaction_date BETWEEN "' + fromdate + '" AND "' + todate + '"',[req.body.acc_number], function (err, results) {
        if (err) {
            ...
            res.render('neftreportgeneration', {
                title: '::-NEFT Report-::',
                results: results,msg:'', userDetails: req.session.userResultList,page:'acc-neft-rpt-sh'
            });
            ...
            connection.query('SELECT *,DATE_FORMAT(transaction_date,"%d-%m-%Y") as tr_date FROM nefttransfer WHERE source_acc_number = ? ORDER BY transaction_date DESC LIMIT 10',[req.body.acc_number], function (err, results) {
                if (err) {
                    ...
                    res.render('neftreportgeneration', {
                        title: '::-NEFT Report-::',
                        results: results, msg:'Last 10 Records is displaying.....',userDetails: req.session.userResultList,page:'acc-neft-rpt-sh'
                    });

                }
                else {
                    res.render('neftreportgeneration', {
                        title: '::-NEFT Report-::', msg: 'No Records Found!', userDetails: req.session.userResultList,page:'acc-neft-rpt-sh'
                    });
                }
            });
        }
        ...
        if (err) {
            ...
            res.redirect('/retail');
                    ...
                    doc.write("statement.pdf",function(err){    
                        if(err){
                            ...
                            res.render('reportgeneration', {
                                ...
                                results: results,msg:'Displaying Last 10 Records....',userDetails: req.session.userResultList,page:'acc-stm-sh'
                            });
                        }else{
                            //res.download("/Users/Sathishkumar.M/Downloads/Netbanking/Netbanking/public/documents","statement.pdf");
                            res.render('reportgeneration', {
                                title: '::-Account Summary Report-::',
                                results: results,msg:'',userDetails: req.session.userResultList,page:'acc-stm-sh'
                            });
                        }
                    }); 
                ...
                if (err) {
                    ...
                    res.render('reportgeneration', {
                        title: '::-Account Statement-::', msg: 'No Records found!', userDetails: req.session.userResultList,page:'acc-stm-sh'
                    });
                }
            });
        }
        ...
        connection.query('SELECT * FROM user', function (err, results) {
            if (err) {
                ...
                res.render('accountstatement', {
                    ...
                    results: results, msg: '', userDetails: req.session.userResultList,page:'acc-stm'
                });

            }
            else {
                res.render('accountstatement', {
                    title: '::-AccountStatement-::', msg: 'No Records Found!', userDetails: req.session.userResultList,page:'acc-stm'
                });
            }
        });
    }
    ...
    if(req.session.userResultList)
    {
        ...
        connection.query(profileUpdateQuery,function (err, results) {
            if (err) {
                ...
                res.render('updateprofile', {
                    title: '::-Profile Updation-::',
                    results: results, msg:'',userDetails: req.session.userResultList,page:''
                });
...
app.get('/changepassword', function (req, res) {
    ...
    res.render('changepassword', {
        title: '::-Change Password-::',msg:'', userDetails: req.session.userResultList,page:'chpwd'
    });
    }
    else
    {
    ...
    if(req.session.userResultList)
    {
        ...
        connection.query('SELECT * FROM user where transaction_password=? and acc_number=?',
            [req.body.trans_password,req.body.acc_number], function (err, results) {
                                    ...
                                    [req.body.acc_number ], function (err, results) {
                                        ...
                                        if (err) {
                                            ...
                                            res.render('changepassword', {
                                                ...
                                                results: results, msg:'Login Password Changed Successfully!',userDetails: req.session.userResultList,page:'chpwd'
                                            });
                                ...
                                connection.query('SELECT *,DATE_FORMAT(date_of_birth,"%d-%M-%Y") as dob FROM user where acc_number=?',
                                    [req.body.acc_number ], function (err, results) {
                                        ...
                                        if (err) {
                                            ...
                                            res.render('changepassword', {
                                                title: '::-Change Password-::',
                                                results: results, msg:'Transaction Password Changed Successfully!',userDetails: req.session.userResultList,page:'chpwd'
                                            });
                ...
                {
                    res.render('changepasswordTransactionPassword', {
                        title: '::-Transaction Password-::',msg:'Invalid Transaction Password',userDetails: req.session.userResultList,changepwdUpdate:req.session.changepwdUpdate,page:'chpwd'
                    });
                }
            });
    ...
    if(req.session.userResultList)
    {
        ...
        if (err) {
            ...
            res.render('beneficiary', {
                ...
                results: results, msg: '',userDetails: req.session.userResultList,page:'bene'
            });
        }
        else {
            res.render('beneficiary', {
                title: '::-Beneficiary Maintain-::',
                results: results, msg: '',userDetails: req.session.userResultList,msg:'',page:'bene'
            });
        }
    });
}
...
app.get('/deleteBeneficiary/:acc/:sacc', function (req, res) {
    if(req.session.userResultList)
    {
        ...
        if (err) {
            ...
            res.render('beneficiary', {
                        title: '::-Beneficiary Maintain-::',
                        results: results, msg: 'Beneficiary Deletion Failure',userDetails: req.session.userResultList,page:'bene'
                    });
        }
        else {
           connection.query('SELECT * FROM beneficiary where source_acc_number=?',[ req.session.userResultList[0].acc_number], function (err, results) {
                if (err) {
                    ...
                    res.render('beneficiary', {
                        title: '::-Beneficiary Maintain-::',
                        results: results, msg: 'Beneficiary Deletion Success',userDetails: req.session.userResultList,page:'bene'
                    });
                }
                else {
                    res.render('beneficiary', {
                        title: '::-Beneficiary Maintain-::',
                        results: results, msg: 'Beneficiary Deletion Success',userDetails: req.session.userResultList,msg:'',page:'bene'
                    });
                }
            });
        }
        ...
        connection.query('SELECT * FROM beneficiary where source_acc_number=? and acc_number=?',[req.body.source_acc_number,req.body.acc_number],
            function (err, results)
            {
                ...
                else if (results.length > 0 && results[0] !== null)
                {
                    res.render('beneficiary', {
                        title: '::-Beneficiary Maintain-::',
                        results: results, userDetails: req.session.userResultList,msg:'You already added the Beneficiary!',page:'bene'
                    });
                }
                else
                {
                    res.render('beneficiaryTransactionPassword', {
                  title: '::-TransactionPassword-::',msg:'',userDetails: req.session.userResultList,beneficiary:req.session.beneficiary,page:'bene-tr'
                  });
                }
        });
    }
                                ...
                                res.redirect('/retail');
                                 ...
                                 connection.query('SELECT * FROM beneficiary where source_acc_number=?',[ req.session.userResultList[0].acc_number], function (err, results) {
                                    if (err) {
                                        ...
                                        res.render('beneficiary', {
                                            title: '::-Beneficiary Maintain-::',
                                            results: results, msg: 'Beneficiary Addition Success',userDetails: req.session.userResultList,msg:'',page:'bene'
                                        });
                                    }
                                });
                                /*res.render('beneficiary', {
        ...
        connection.query('INSERT INTO `feedback_complaint`(`type_of_query`,`type_of_services`,`customer_id`,`customer_name`,`email`,`mobile`,`address`,`comments`,`query_date`,`query_status`)VALUES(?,?,?,?,?,?,?,?,?,?)',[req.body.query_type,req.body.type_of_services,req.body.customer_id,req.body.first_name,req.body.email,req.body.phone,req.body.address,req.body.comments,new Date(),0],function(err){
            if(err){
                ...
                res.render('feedback_complaint', {
                    ...
                    userDetails: req.session.userResultList,
                    results: req.session.userResultList,
                    msg:'Feedback/Complaint updated successfully',page:''
                });
            }
        });
